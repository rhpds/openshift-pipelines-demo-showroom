...
- External link caret enforcement (`^` for new tabs)
- Clickable image validation (external links with `^`)
- Non-clickable image detection (ALL images must use `link=self,window=blank` or external link)
- List marker semantic validation (bullets vs numbered)
- List blank line enforcement
